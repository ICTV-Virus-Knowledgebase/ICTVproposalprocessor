...
xlsx_out_accession=c("Accessions")
...
xlsx_out_colnames = c(
  "sort","proposal_abbrev","filename","spreadsheet",
  xlsx_in_colnames,
  "errors"
)
...
for(pro_zip in rownames(zipDf) ) {
  ...
  pro_df = cbind(
    sort=           rep(NA,            okCount),
    proposal_abbrev=rep(pro_xls_number,okCount),
    proposal=       rep(pro_zip,       okCount),
    spreadsheet=    rep(pro_xls_fname, okCount),
    df[changeOk,],
